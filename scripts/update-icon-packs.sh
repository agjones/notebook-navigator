...
if [[ $# -eq 0 ]]; then
    ...
    echo "  --generate-only  Regenerate bundled manifest files from local icon-assets"
    ...
    echo "  ./scripts/update-icon-packs.sh --generate-only     # Rewrite generated manifest files"
